...
function MainMenu() {
    ...
    return (
        <div>
            ...
            <Link to={`/user/${userFound._id}/lists/new`} className='bg-black bg-opacity-10 text-4xl flex gap-10 p-4 text-text justify-between items-center'><i className="text-text p-2 rounded-full bg-tertiary ri-play-list-add-line"></i>Crear Lista</Link>
